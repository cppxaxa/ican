...
!(function (e, t) {
    ...
    var d = (function () {
        function e(e) {
            ...
            if (
                ...
                t.util.assert(this.overlapFactor >= 0 && this.overlapFactor < 1, function () {
                                ...
                                return (
                                    ...
                                    this.freqData[0] === -1 / 0
                                        ...
                                        : (this.freqDataQueue.push(this.freqData.slice(0, this.columnTruncateLength)),
                                          this.includeRawAudio && (this.analyser.getFloatTimeDomainData(this.timeData), this.timeDataQueue.push(this.timeData.slice())),
                                          this.freqDataQueue.length > this.numFrames && this.freqDataQueue.shift(),
                                          this.tracker.tick()
                                              ? ((e = p(this.freqDataQueue)),
                                                (r = f(e, [1, this.numFrames, this.columnTruncateLength, 1])),
                                                (n = void 0),
                                                this.includeRawAudio && ((a = p(this.timeDataQueue)), (n = f(a, [1, this.numFrames * this.fftSize]))),
            ...
            function e(e) {
                if (((this.examples = {}), (this.label2Ids = {}), null != e))
                    for (
                        ...
                        null != i.rawAudioNumSamples && (s += i.rawAudioNumSamples), (s *= 4), this.addExample(T({ spec: i, data: r.data.slice(n, n + s) })), (n += s);
                    }
            }
            return (
                ...
                (e.prototype.getData = function (e, r) {
                    ...
                    1 === l.length
                        ? ((i = null == r.numFrames ? l[0] : r.numFrames), (s = null == r.hopFrames ? 1 : r.hopFrames))
                        : ((i = r.numFrames),
                          t.util.assert(null != i && Number.isInteger(i) && i > 0, function () {
                          ...
                          (s = r.hopFrames),
                          t.util.assert(null != s && Number.isInteger(s) && s > 0, function () {
                    ...
                    return t.tidy(function () {
                        ...
                        if (r.getDataset) {
                            var E = null == r.datasetBatchSize ? 32 : r.datasetBatchSize,
                                T = null == r.datasetValidationSplit ? 0.15 : r.datasetValidationSplit;
                ...
                (e.prototype.augmentByMixingNoise = function (e, r, n) {
                    ...
                    var f = [],
                        ...
                        g = function (a) {
                            var i,
                                o,
                                l = c[((i = 0), (o = c.length), Math.floor((o - i) * Math.random()) + i)],
                    ...
                    console.log("Data augmentation: mixing noise: added " + f.length + " examples"),
                ...
                (e.prototype.serialize = function (e) {
                    ...
                    return (l = { manifest: p, data: g(f) }), (u = y(JSON.stringify(l.manifest))), (c = y(w)), (h = new Uint32Array([x])), (d = new Uint32Array([u.byteLength])), g([g([c, h.buffer, d.buffer]), u, l.data]);
                }),
                e
            );
        })();
    function E(e) {
        var t = null != e.rawAudio,
            r = { label: e.label, spectrogramNumFrames: e.spectrogram.data.length / e.spectrogram.frameSize, spectrogramFrameSize: e.spectrogram.frameSize };
        ...
        return t && ((r.rawAudioNumSamples = e.rawAudio.data.length), (r.rawAudioSampleRateHz = e.rawAudio.sampleRateHz), (n = g([n, e.rawAudio.data.buffer]))), { spec: r, data: n };
    }
    function T(e) {
    ...
    var D = "0.4.2",
        ...
        A = { localStorage: "undefined" == typeof window ? null : window.localStorage };
    var R = (function () {
            function e(r, n, a) {
                (this.MODEL_URL_PREFIX = window.location.href.substring(0, window.location.href.lastIndexOf('/')) + "/speech-commands/v" + D.split(".").slice(0, 2).join(".") + "/browser_fft"),
                    (this.SAMPLE_RATE_HZ = 44100),
                    (this.FFT_SIZE = 1024),
                    (this.DEFAULT_SUPPRESSION_TIME_MILLIS = 0),
                    (this.streaming = !1),
                    (this.transferRecognizers = {}),
                    t.util.assert((null == n && null == a) || (null != n && null != a), function () {
                        return "modelURL and metadataURL must be both provided or both not provided.";
                    }),
                    null == n
                        ? (null == r
                              ? (r = e.DEFAULT_VOCABULARY_NAME)
                              : t.util.assert(-1 !== e.VALID_VOCABULARY_NAMES.indexOf(r), function () {
                            ...
                            switch (m.label) {
                                ...
                                case 1:
                                    if (
                                        (m.sent(),
                                        null == r && (r = {}),
                                        (n = null == r.probabilityThreshold ? 0 : r.probabilityThreshold),
                                        r.includeEmbedding && (n = 0),
                                        t.util.assert(n >= 0 && n <= 1, function () {
                                            return "Invalid probabilityThreshold value: " + n;
                                        }),
                                        (a = null != r.invokeCallbackOnNoiseAndUnknown && r.invokeCallbackOnNoiseAndUnknown),
                                        r.includeEmbedding && (a = !0),
                                        r.suppressionTimeMillis < 0)
                                    )
                                        throw new Error("suppressionTimeMillis is expected to be >= 0, but got " + r.suppressionTimeMillis);
                                    return (
                                            ...
                                            return i(f, void 0, void 0, function () {
                                                ...
                                                return s(this, function (s) {
                                                    switch (s.label) {
                                                        ...
                                                        case 8:
                                                            return (b = !0), a || ("_background_noise_" !== this.words[m] && "_unknown_" !== this.words[m]) || (b = !1), b && e({ scores: p, spectrogram: v, embedding: d }), [2, b];
                                                    }
                                                });
                                            });
                                        }),
                                        (p = null == r.suppressionTimeMillis ? this.DEFAULT_SUPPRESSION_TIME_MILLIS : r.suppressionTimeMillis),
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return s(this, function (s) {
                            switch (s.label) {
                                ...
                                case 1:
                                    return s.sent(), "string" != typeof this.modelArtifactsOrURL ? [3, 3] : [4, t.loadLayersModel(this.modelArtifactsOrURL)];
                                case 2:
                                    return (e = s.sent()), [3, 5];
                                case 3:
                                ...
                                case 5:
                                    ...
                                    return (
                                        ...
                                        this.warmUpModel(),
                                        (n = (this.parameters.fftSize / this.parameters.sampleRateHz) * 1e3),
                        ...
                        return s(this, function (n) {
                            switch (n.label) {
                                ...
                                case 1:
                                    ...
                                    return (this.modelWithEmbeddingOutput = t.model({ inputs: this.model.inputs, outputs: [this.model.outputs[0], e.output] })), [2];
                            }
                        });
                    });
                }),
                                                      ...
                                                      return s(this, function (s) {
                                                          switch (s.label) {
                                                              ...
                                                              case 2:
                                                                  return [2, s.sent()];
                                                              case 3:
                                                                  return 0 !== e.indexOf(a) ? [3, 5] : ((i = require("fs")), (o = r.promisify(i.readFile)), (u = (l = JSON).parse), [4, o(e.slice(a.length), { encoding: "utf-8" })]);
                                                              case 4:
                                ...
                                case 3:
                                    if (e instanceof t.Tensor) this.checkInputTensorShape(e), (i = e), (a = e.shape[0]);
                                        ...
                                        if (e.length % this.elementsPerExample)
                                            throw new Error("The length of the input Float32Array " + e.length + " is not divisible by the number of tensor elements per per example expected by the model " + this.elementsPerExample + ".");
                                        (a = e.length / this.elementsPerExample), (i = t.tensor4d(e, [a].concat(this.nonBatchInputShape)));
                                    }
                                    return (l = { scores: null }), r.includeEmbedding ? [4, this.ensureModelWithEmbeddingOutputCreated()] : [3, 5];
                                case 4:
        ...
        O = (function (e) {
            function r(r, n, a) {
                ...
                return (
                    ...
                    (i.parameters = n),
                    (i.baseModel = a),
                    t.util.assert(null != r && "string" == typeof r && r.length > 0, function () {
            ...
            return (
                            ...
                            return (
                                null != r.durationSec
                                    ...
                                    ? (t.util.assert(r.durationMultiplier >= 1, function () {
                                      ...
                                      (n = Math.round(this.nonBatchInputShape[0] * r.durationMultiplier)))
                                            ...
                                            spectrogramCallback: function (n, o) {
                                                return i(u, void 0, void 0, function () {
                                                    ...
                                                    return s(this, function (s) {
                                                        switch (s.label) {
                                                            case 0:
                                                                return null != r.onSnippet ? [3, 7] : ((i = h(n)), (u = (l = this.dataset).addExample), (d = { label: e }), (p = {}), [4, i.data()]);
                                                            case 1:
                                                            ...
                                                            case 8:
                                                                ...
                                                                return (
                                                                    ...
                                                                    y.push(M),
                                                                    null != r.onSnippet && r.onSnippet({ data: M, frameSize: this.nonBatchInputShape[1] }),
                                                            ...
                                                            case 9:
                                                                return (
                                                                    ...
                                                                    (D = { data: z, frameSize: this.nonBatchInputShape[1] }),
                ...
                (r.prototype.collectTransferDataAsTensors = function (e, t) {
                    ...
                    var n = Math.round(e * r),
                        i = this.dataset.getData(null, a({ numFrames: r, hopFrames: n }, t));
                ...
                (r.prototype.collectTransferDataAsTfDataset = function (e, t, r, n) {
                    ...
                    return this.dataset.getData(null, a({ numFrames: i, hopFrames: s, getDataset: !0, datasetBatchSize: r, datasetValidationSplit: t }, n));
                }),
                (r.prototype.train = function (e) {
                    return i(this, void 0, void 0, function () {
                        ...
                        return s(this, function (a) {
                            return (
                                t.util.assert(null != this.words && this.words.length > 0, function () {
                                ...
                                null != e.fineTuningEpochs &&
                                    t.util.assert(e.fineTuningEpochs >= 0 && Number.isInteger(e.fineTuningEpochs), function () {
                                ...
                                (r = null == e.fitDatasetDurationMillisThreshold ? 6e4 : e.fitDatasetDurationMillisThreshold),
                                this.dataset.durationMillis() > r
                                    ? (console.log("Detected large dataset: total duration = " + this.dataset.durationMillis() + " ms > " + r + " ms. Training transfer model using fitDataset() instead of fit()"),
                            ...
                            switch (s.label) {
                                case 0:
                                    return (
                                        ...
                                        (a = l(this.collectTransferDataAsTfDataset(n, e.validationSplit, r, { augmentByMixingNoiseRatio: e.augmentByMixingNoiseRatio }), 2)),
                                        (i = a[0]),
                                        (o = a[1]),
                                        (u = t.util.now()),
                                        [4, this.model.fitDataset(i, { epochs: e.epochs, validationData: e.validationSplit > 0 ? o : null, callbacks: null == e.callback ? null : [e.callback] })]
                                    );
                                case 1:
                                    return (
                                        (c = s.sent()),
                                        console.log("fitDataset() took " + (t.util.now() - u).toFixed(2) + " ms"),
                                        null != e.fineTuningEpochs && e.fineTuningEpochs > 0 ? ((h = t.util.now()), [4, this.fineTuningUsingTfDatasets(e, i, o)]) : [3, 3]
                                    );
                                case 2:
                            ...
                            switch (s.label) {
                                case 0:
                                    (r = e.windowHopRatio || 0.25),
                                        (n = this.collectTransferDataAsTensors(r, { augmentByMixingNoiseRatio: e.augmentByMixingNoiseRatio })),
                                        (a = n.xs),
                                        (i = n.ys),
                                        console.log("Training data: xs.shape = " + a.shape + ", ys.shape = " + i.shape),
                                        (s.label = 1);
                                case 1:
                                    return (
                                        s.trys.push([1, , 6, 7]),
                                            ...
                                            ? ((c = (function (e, r, n) {
                                                  return (
                                                      ...
                                                      t.tidy(function () {
                                                          ...
                                                          return { trainXs: t.gather(e, u), trainYs: t.gather(r, u), valXs: t.gather(e, c), valYs: t.gather(r, c) };
                                                      })
                                                  );
                                              ...
                                              (u = [c.valXs, c.valYs]))
                                            : ((o = a), (l = i)),
                                        [4, this.model.fit(o, l, { epochs: null == e.epochs ? 20 : e.epochs, validationData: u, batchSize: e.batchSize, callbacks: null == e.callback ? null : [e.callback] })]
                                    );
                                case 2:
                            ...
                            switch (s.label) {
                                case 0:
                                    return (
                                        ...
                                        (a = null == e.fineTuningOptimizer ? "sgd" : e.fineTuningOptimizer),
                                        this.model.compile({ loss: "categoricalCrossentropy", optimizer: a, metrics: ["acc"] }),
                                        [4, this.model.fitDataset(t, { epochs: e.fineTuningEpochs, validationData: r, callbacks: null == e.callback ? null : [e.callback] })]
                                    );
                                case 1:
                            ...
                            switch (s.label) {
                                case 0:
                                    return (
                                        ...
                                        (this.secondLastBaseDenseLayer.trainable = !0),
                                        (i = null == e.fineTuningOptimizer ? "sgd" : e.fineTuningOptimizer),
                                        this.model.compile({ loss: "categoricalCrossentropy", optimizer: i, metrics: ["acc"] }),
                                        [4, this.model.fit(t, r, { epochs: e.fineTuningEpochs, validationData: n, batchSize: e.batchSize, callbacks: null == e.fineTuningCallback ? null : [e.fineTuningCallback] })]
                                    );
                                case 1:
                ...
                (r.prototype.evaluate = function (e) {
                    return i(this, void 0, void 0, function () {
                        ...
                        return s(this, function (a) {
                            return (
                                t.util.assert(null != e.wordProbThresholds && e.wordProbThresholds.length > 0, function () {
                                    return "Received null or empty wordProbThresholds";
                                }),
                                (r = 0),
                                t.util.assert("_background_noise_" === this.words[r], function () {
                                    ...
                                    t.tidy(function () {
                                        for (
                                            var a = [],
                                                ...
                                                u = n.model.predict(o),
                                                c = u.slice([0, 1], [u.shape[0], u.shape[1] - 1]).max(-1),
                                                h = u.shape[0],
                                                d = 0;
                                            ...
                                            a.push({ probThreshold: p, fpr: w, tpr: x }),
                                                console.log("ROC thresh=" + p + ": fpr=" + w.toFixed(4) + ", tpr=" + x.toFixed(4)),
                                                d > 0 && (i += (Math.abs(a[d - 1].fpr - a[d].fpr) * (a[d - 1].tpr + a[d].tpr)) / 2);
                                        }
                ...
                (r.prototype.createTransferModelFromBaseModel = function () {
                    ...
                    (this.transferHead = t.sequential()), this.transferHead.add(t.layers.dense({ units: this.words.length, activation: "softmax", inputShape: a.shape.slice(1), name: "NewHeadDense" }));
                ...
                (r.prototype.getMetadata = function () {
                    return { tfjsSpeechCommandsVersion: D, modelName: this.name, timeStamp: new Date().toISOString(), wordLabels: this.wordLabels() };
                }),
                    ...
                    return i(this, void 0, void 0, function () {
                        ...
                        return s(this, function (a) {
                            return (
                                (t = null != e),
                                (e = e || C(this.name)),
                                t || ((r = A.localStorage.getItem(I)), ((n = null == r ? {} : JSON.parse(r))[this.name] = this.getMetadata()), A.localStorage.setItem(I, JSON.stringify(n))),
